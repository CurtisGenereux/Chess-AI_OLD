...
public class Main {
	...
	public static void main(String[] args) {
		...
		// asign pieces
		for (int i = 0; i < 8; i++) {
		    Piece whitePiece = new Piece(i, 1, "white-pawn", pieces);
		    Piece blackPiece = new Piece(i, 6, "black-pawn", pieces);
		    pieces.add(whitePiece);
		    pieces.add(blackPiece);
		    board[i][6] = whitePiece;
		    board[i][1] = blackPiece;
		}
		...
		for (Piece piece : pieces) {
		    if (piece.name.equals("white-pawn")) {
		        piece.move(4, 7);
		        break;
		    }
		}
